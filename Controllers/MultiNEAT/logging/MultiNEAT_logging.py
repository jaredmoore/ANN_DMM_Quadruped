...
def write_population_statistics(filename, genomes, fitnesses, generation, optional_additions=""):
    ...
    Args:
        ...
        optional_additions: tuple containing other rows to add
    """
        ...
        if genomes:
            for i,(gen,fitness) in enumerate(zip(genomes,fitnesses)):
                f.write(str(generation)+
                        ...
                        ","+str(fitness))
                if(optional_additions):
                    for j in range(len(optional_additions[i])):
                        f.write(","+str(optional_additions[i][j]))
                    pass
                f.write("\n")
        else:
